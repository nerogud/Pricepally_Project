...
public class TC_005_LoginFunctionalityWithoutCredentials extends BaseClass{
	...
	@Test
	public void LoginFunctionalityWithoutCredentials() throws InterruptedException {
		
		logger.info("***Starting LoginFunctionalityWithoutCredentials Test***");
		...
		//intentionally skip login details;
